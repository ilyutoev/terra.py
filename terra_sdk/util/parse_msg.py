...
from terra_sdk.core.ibc.msgs import (MsgAcknowledgement,
                                     MsgChannelCloseConfirm,
                                     MsgChannelCloseInit, MsgChannelOpenAck,
                                     MsgChannelOpenConfirm, MsgChannelOpenInit,
                                     MsgChannelOpenTry, MsgConnectionOpenAck,
...
from terra_sdk.core.oracle import (MsgAggregateExchangeRatePrevote,
                                   MsgAggregateExchangeRateVote,
                                   MsgDelegateFeedConsent)
from terra_sdk.core.slashing import MsgUnjail
from terra_sdk.core.staking import (MsgBeginRedelegate, MsgCreateValidator,
                                    MsgDelegate, MsgEditValidator,
                                    MsgUndelegate)
from terra_sdk.core.wasm import (MsgClearContractAdmin, MsgExecuteContract,
                                 MsgInstantiateContract, MsgMigrateCode,
                                 MsgMigrateContract, MsgStoreCode,
...
bank_protos = [[MsgSend.type_url, MsgSend_pb], [MsgMultiSend.type_url, MsgMultiSend_pb]]
distribution_protos = [
...
slashing_protos = [[MsgUnjail.type_url, MsgUnjail_pb]]
staking_protos = [
...
ibc_transfer_protos = [[MsgTransfer.type_url, MsgTransfer_pb]]
ibc_protos = [
